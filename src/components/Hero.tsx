    ...
    <div id="hero" className="hero bg-gradient-to-b from-base-200 to-base-100">
      <div className="hero-content text-center py-12">
        <div className="max-w-5xl">
          ...
          {/* Video Demo Section */}
          <div className="relative w-full max-w-4xl mx-auto mt-8 mb-8 animate-fade-in-up">
          ...
          <div className="flex flex-col md:flex-row gap-6 items-center justify-center mt-8 animate-fade-in-up">
